    ...
    public function getNavigation()
    {
        return array(
            array(
                ...
                'items'   => array(
                    array(
                        'label'   => Yii::t('user', 'Управляющие'),
                        'url'     => array( '/user/manager/index' ),
                        'visible' => Yii::app()->user->checkAccess('showUserManager'),
                    ),
                    array(
                        'label'   => Yii::t('user', 'Преподаватели'),
                        'url'     => array( '/user/educator/index' ),
                        'visible' => Yii::app()->user->checkAccess('showUserEducator'),
                    ),
                    array(
                        'label'   => Yii::t('user', 'Слушатели'),
                        'url'     => array( '/user/listener/index' ),
                        'visible' => Yii::app()->user->checkAccess('showUserListener'),
                    ),
                    array(
                        'label'   => Yii::t('user', 'Абитуриенты'),
                        'url'     => array( '/user/entrant/index' ),
                        'visible' => Yii::app()->user->checkAccess('showUserEntrant'),
                    ),
                    array(
                        'label'   => Yii::t('user', 'Студенты'),
                        'url'     => array( '/user/student/index' ),
                        'visible' => Yii::app()->user->checkAccess('showUserStudent'),
                    ),
                    array(
                        'label'       => '',
                        'url'         => 'javascript:void(0)',
