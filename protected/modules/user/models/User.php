...
class User extends CActiveRecord
{
    ...
    public function rules()
    {
        return array(
            ...
            array( 'username', 'match', 'pattern' => '/^[A-Za-z0-9\-]+$/iu', 'message' => Yii::t('user', 'Логин должен состоять из латинских букв и цифр') ),
            ...
            array( 'id, username, email, phone, create_date, update_date, last_visit, activation_key, status, read_only, sort', 'safe', 'on' => 'search' ),
        );
    }
