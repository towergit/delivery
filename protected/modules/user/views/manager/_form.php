        ...
        <div class="tab-pane active" id="tab1">
            <div class="row">
                ...
                <div class="col-sm-3">
                    ...
                    ?>
                    <?php
                    $model->last_visit   = Date::format($model->last_visit, 'dd.MM.y HH:mm');
                    echo $form->textFieldControlGroup($model, 'last_visit', array( 'disabled' => true ));
                    ?>
        ...
        <div class="tab-pane" id="tab2">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <?php echo $form->dropDownListControlGroup($profile, 'gender', $profile->genderList); ?>
                </div>
            </div>
