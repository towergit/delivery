...
class OutputController extends BackendController
{
     ...
     */
    public $defaultModel = 'OutputMoney';
    ...
    public function accessRules()
    {
        return array(
            array( 'allow',
                'actions' => array( 'index' ),
                'roles'   => array( 'showPaymentOutputMoney' ),
            ),
            array( 'allow',
                'actions' => array( 'create' ),
                'roles'   => array( 'createPaymentOutputMoney' ),
            ),
            array( 'allow',
                'actions' => array( 'toggle', 'update' ),
                'roles'   => array( 'updatePaymentOutputMoney' ),
            ),
            array( 'allow',
                'actions' => array( 'delete' ),
                'roles'   => array( 'deletePaymentOutputMoney' ),
            ),
            array( 'deny',
                'users' => array( '*' ),
            ),
