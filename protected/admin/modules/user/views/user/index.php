<?php
// название страницы
$this->pageTitle = Yii::t('user', 'Список пользователей');
                ...
                array(
                    ...
                    'buttons'    => array(
                        array(
                            ...
                            'icon'    => 'fa fa-plus',
                            'url'     => array( 'create' ),
                            'visible' => Yii::app()->user->checkAccess('createUser')
                        ),
                    ),
                ),
            ),
		...
		$('#User_create_date, #User_last_visit').datepicker({
            ...
            'columns'         => array(
                ...
                array(
                    ...
                    'visible'      => Yii::app()->user->checkAccess('updateUser'),
                ),
                array(
                    ...
                    'buttons'     => array(
                        ...
                        'delete' => array(
                            'visible' => 'Yii::app()->user->checkAccess("deleteUser")',
                        ),
                    ),
                    'htmlOptions' => array(
                        'nowrap' => 'nowrap',
