            ...
            else
            {
                switch($this->_identity->errorCode)
                {
                    ...
                    case UserIdentity::ERROR_USERNAME_INVALID:
                        $this->addError('username', Yii::t('user', 'Неверный логин'));
                        break;

                    case UserIdentity::ERROR_PASSWORD_INVALID:
                        $this->addError('password', Yii::t('user', 'Неверный пароль'));
                        break;

                    case UserIdentity::ERROR_NOTACTIVE:
                        $this->addError('username', Yii::t('user', 'Пользователь не активен'));
                        break;

                    case UserIdentity::ERROR_BANNED:
                        $this->addError('username', Yii::t('user', 'Пользователь забанен'));
                        break;
                }
            }
        }
