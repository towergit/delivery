...
<div class="panel">
    ...
    <ul class="nav nav-tabs nav-tabs-simple" role="tablist">
        <li class="active">
            <a href="#tab1" data-toggle="tab" role="tab"><?php echo Yii::t('gallery', 'Основные данные'); ?></a>
        </li>
        <li>
            <a href="#tab2" data-toggle="tab" role="tab"><?php echo Yii::t('gallery', 'Описание'); ?></a>
        </li>
        <li>
            <a href="#tab3" data-toggle="tab" role="tab"><?php echo Yii::t('gallery', 'SEO'); ?></a>
        </li>
    </ul>
