<?php
// название страницы
$this->pageTitle = Yii::t('gallery', 'Категории галереи');
...
<div class="row">
    <div class="col-sm-12">
                ...
                array(
                    ...
                    'buttons'    => array(
                        array(
                            ...
                            'icon'    => 'fa fa-plus',
                            'url'     => array( 'create' ),
                            'visible' => Yii::app()->user->checkAccess('createGalleryCategory'),
                        ),
                    ),
                ),
            ),
		...
		$('#GalleryCategory_create_date').datepicker({
                    format: 'dd.mm.yyyy'
		}); 
            }",
            'columns'         => array(
                ...
                array(
                    ...
                    'visible'      => Yii::app()->user->checkAccess('updateGalleryCategory'),
                ),
                array(
                    ...
                    'buttons'     => array(
                        ...
                        'delete' => array(
                            'visible' => 'Yii::app()->user->checkAccess("deleteGalleryCategory")',
                        ),
                    ),
                    'htmlOptions' => array(
                        'nowrap' => 'nowrap',
                    ...
                    'visible'     =>
                        Yii::app()->user->checkAccess("updateGalleryCategory") 
                        || Yii::app()->user->checkAccess("deleteGalleryCategory")
                )
            ),
        ));
