 ...
 */
class SubscribeModule extends WebModule
{
    /**
    ...
    {
        return Yii::t('material', 'Подпищики');
    }
    ...
    {
        return Yii::t('material', 'Управление подпищиками');
    }
    ...
    public function getNavigation()
    {
        return array(
            array(
                'label'   => Yii::t('material', 'Подапищеки'),
                'icon'    => $this->icon,
               ...
               // 'visible' => Yii::app()->user->checkAccess('showMaterial'),
                'items'   => array(
                   /* array(
                    ...
                    array(
                        'label'   => Yii::t('material', 'Список подписчиков'),
