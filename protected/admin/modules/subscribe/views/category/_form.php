    ...
    'headerButtons' => array(
            ...
            'buttons'    => array(
                array(
                    'label'       => $model->isNewRecord 
                        ? Yii::t('material', 'Добавить и продолжить') 
                        : Yii::t('material', 'Сохранить и продолжить'),
        ...
        array(
            ...
            'buttons'    => array(
                array(
                    'label'       => $model->isNewRecord 
                        ? Yii::t('material', 'Добавить и закрыть') 
                        : Yii::t('material', 'Сохранить и закрыть'),
                    'icon'        => 'fa fa-floppy-o',
                    'htmlOptions' => array(
                        'name'  => 'submit-type',
                        'value' => 'index',
...
<div class="panel">
    ...
    <ul class="nav nav-tabs nav-tabs-simple" role="tablist">
        <li class="active">
            <a href="#tab1" data-toggle="tab" role="tab"><?php echo Yii::t('material', 'Основные данные'); ?></a>
        </li>
        <li>
            <a href="#tab2" data-toggle="tab" role="tab"><?php echo Yii::t('material', 'Описание'); ?></a>
        </li>
        <li>
            <a href="#tab3" data-toggle="tab" role="tab"><?php echo Yii::t('material', 'SEO'); ?></a>
        </li>
    </ul>
