    ...
    'headerButtons' => array(
            ...
            'buttons'    => array(
                array(
                    'label'       => $model->isNewRecord 
                        ? Yii::t('ticket', 'Добавить и продолжить') 
                        : Yii::t('ticket', 'Сохранить и продолжить'),
        ...
        array(
            ...
            'buttons'    => array(
                array(
                    'label'       => $model->isNewRecord 
                        ? Yii::t('ticket', 'Добавить и закрыть') 
                        : Yii::t('ticket', 'Сохранить и закрыть'),
                    'icon'        => 'fa fa-floppy-o',
                    'htmlOptions' => array(
                        'name'  => 'submit-type',
                        'value' => 'index',
...
<div class="panel">
    ...
    <ul class="nav nav-tabs nav-tabs-simple" role="tablist">
        <li class="active">
            <a href="#tab1" data-toggle="tab" role="tab"><?php echo Yii::t('ticket', 'Основные данные'); ?></a>
        </li>
        <li>
            <a href="#tab2" data-toggle="tab" role="tab"><?php echo Yii::t('ticket', 'Описание'); ?></a>
        </li>
        <li>
            <a href="#tab3" data-toggle="tab" role="tab"><?php echo Yii::t('ticket', 'SEO'); ?></a>
        </li>
    </ul>
